...
const REGISTRY = {
  ...
  elasticmq: {
    ...
    runArgs: [
      '-p', `127.0.0.1:${PORTS.elasticmq}:9324`,
      '-p', `127.0.0.1:${PORTS.elasticmqConsole}:9325`,
      'softwaremill/elasticmq-native',
    ],
    ready: { type: 'http', target: `http://127.0.0.1:${PORTS.elasticmq}/` },
    endpoint: `http://127.0.0.1:${PORTS.elasticmq}`,
    consoleUrl: `http://127.0.0.1:${PORTS.elasticmqConsole}`,
    env: { AWS_ENDPOINT_URL_SQS: `http://127.0.0.1:${PORTS.elasticmq}` },
    credentials: AWS_CREDENTIALS,
  },
  dynamodb: {
